...
var slot = 0;
var settings_page = 1;
var settings_haspages;
var settings_userdata = [];
var file = {};
var completed = false;
var wsUri;
...
function settings_getnextpage() {
	if (page < settings_haspages) {
		page = page + 1;
		var commandtosend = {};
		commandtosend.command = "userlist";
		commandtosend.page = page;
...
function settings_builduserdata(obj) {
	settings_userdata = settings_userdata.concat(obj.list);
}
